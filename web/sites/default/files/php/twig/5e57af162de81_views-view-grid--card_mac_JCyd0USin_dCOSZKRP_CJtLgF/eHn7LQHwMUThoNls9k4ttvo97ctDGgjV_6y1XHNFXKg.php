...
/* themes/custom/mina/card machines page override/views-view-grid--card_machines.html.twig */
class __TwigTemplate_4e9575d8b04eb3caa9747064bb0bc3e3affd4ca62646f3e95878c12f200d479e extends \Twig\Template
{
...
";
        ...
        // line 54
        echo "<div";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "card_machines_cols"], "method")), "html", null, true);
        echo ">
  ";
        // line 55
        ...
        ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                    // line 59
                    echo "          <div";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($context["column"], "attributes", []), "addClass", [0 => "cardmachinewidth", 1 => ($context["col_classes"] ?? null), 2 => (($this->getAttribute(($context["options"] ?? null), "col_class_default", [])) ? (("col-" . $this->sandbox->ensureToStringAllowed($this->getAttribute($context["loop"], "index", [])))) : (""))], "method")), "html", null, true);
                    echo ">";
                    // line 60
...
";
    ...
    {
        return "themes/custom/mina/card machines page override/views-view-grid--card_machines.html.twig";
    }
...
{% if title %}
  <h3>{{ title }}</h3>
{% endif %}
<div{{ attributes.addClass(classes,'card_machines_cols') }}>
  {% if options.alignment == 'horizontal' %}
    {% for row in items %}
      <div{{ row.attributes.addClass('rownpad',row_classes, options.row_class_default ? 'row-' ~ loop.index) }}>
        {% for column in row.content %}
          <div{{ column.attributes.addClass('cardmachinewidth',col_classes, options.col_class_default ? 'col-' ~ loop.index) }}>
            {{- column.content -}}
          </div>
        {% endfor %}
      </div>
...
", "themes/custom/mina/card machines page override/views-view-grid--card_machines.html.twig", "/var/www/html/project9/web/themes/custom/mina/card machines page override/views-view-grid--card_machines.html.twig");
    }
}
